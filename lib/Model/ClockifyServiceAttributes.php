...
/**
 * ClockifyServiceAttributes Class Doc Comment
 *
 * @category Class
 * @description The Clockify Service Attributes.
 * @package  Skriptfabrik\ApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ClockifyServiceAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClockifyServiceAttributes';
    ...
    */
     ...
     * Sets _id
     *
     * @param string|null $_id Clockify service identifier
     *
     * @return self
     */
    public function setId($_id)
    {
        if (!is_null($_id) && (mb_strlen($_id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $_id when calling ClockifyServiceAttributes., must be smaller than or equal to 26.');
        }
        if (!is_null($_id) && (mb_strlen($_id) < 26)) {
            throw new \InvalidArgumentException('invalid length for $_id when calling ClockifyServiceAttributes., must be bigger than or equal to 26.');
        }
        if (!is_null($_id) && (!preg_match("/^[0-9A-HJ-KM-NP-TV-Z]{26}$/", $_id))) {
            throw new \InvalidArgumentException("invalid value for \$_id when calling ClockifyServiceAttributes., must conform to the pattern /^[0-9A-HJ-KM-NP-TV-Z]{26}$/.");
        }
     ...
     * Sets status
     *
     * @param string $status MOCO service status
     *
     * @return self
     */
     ...
     * Sets api_key
     *
     * @param string $api_key MOCO API key
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling ClockifyServiceAttributes., must be bigger than or equal to 1.');
        }
