...
/**
 * MocoServiceAttributes Class Doc Comment
 *
 * @category Class
 * @description The MOCO Service Attributes.
 * @package  Skriptfabrik\ApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MocoServiceAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MocoServiceAttributes';
    ...
    */
     ...
     * Sets _id
     *
     * @param string|null $_id MOCO service identifier
     *
     * @return self
     */
    public function setId($_id)
    {
        if (!is_null($_id) && (mb_strlen($_id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $_id when calling MocoServiceAttributes., must be smaller than or equal to 26.');
        }
        if (!is_null($_id) && (mb_strlen($_id) < 26)) {
            throw new \InvalidArgumentException('invalid length for $_id when calling MocoServiceAttributes., must be bigger than or equal to 26.');
        }
        if (!is_null($_id) && (!preg_match("/^[0-9A-HJ-KM-NP-TV-Z]{26}$/", $_id))) {
            throw new \InvalidArgumentException("invalid value for \$_id when calling MocoServiceAttributes., must conform to the pattern /^[0-9A-HJ-KM-NP-TV-Z]{26}$/.");
        }
    ...
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling MocoServiceAttributes., must be bigger than or equal to 1.');
        }
