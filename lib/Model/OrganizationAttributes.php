 ...
 *
 * @category Class
 * @description The Organization Attributes.
 * @package  Skriptfabrik\ApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrganizationAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Organization_Attributes';
    ...
    */
     ...
     * Sets _id
     *
     * @param string|null $_id Organization identifier
     *
     * @return self
     */
    public function setId($_id)
    {
        if (!is_null($_id) && (mb_strlen($_id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $_id when calling OrganizationAttributes., must be smaller than or equal to 26.');
        }
        if (!is_null($_id) && (mb_strlen($_id) < 26)) {
            throw new \InvalidArgumentException('invalid length for $_id when calling OrganizationAttributes., must be bigger than or equal to 26.');
        }
        if (!is_null($_id) && (!preg_match("/^[0-9A-HJ-KM-NP-TV-Z]{26}$/", $_id))) {
            throw new \InvalidArgumentException("invalid value for \$_id when calling OrganizationAttributes., must conform to the pattern /^[0-9A-HJ-KM-NP-TV-Z]{26}$/.");
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OrganizationAttributes., must be smaller than or equal to 30.');
        }
