...
/**
 * ClockifyHookResponse Class Doc Comment
 *
 * @category Class
 * @package  Skriptfabrik\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ClockifyHookResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClockifyHookResponse';
    ...
    */
    ...
    public function setIncluded($included)
    {
        ...
        if (!is_null($included) && (count($included) > 2)) {
            throw new \InvalidArgumentException('invalid value for $included when calling ClockifyHookResponse., number of items must be less than or equal to 2.');
        }
        if (!is_null($included) && (count($included) < 1)) {
            throw new \InvalidArgumentException('invalid length for $included when calling ClockifyHookResponse., number of items must be greater than or equal to 1.');
        }
