<?php
/**
 * ClockifySettingsCollectionResponseMeta
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ClockifySettingsCollectionResponseMeta Class Doc Comment
 *
 * @category Class
 * @package  Skriptfabrik\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ClockifySettingsCollectionResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClockifySettingsCollectionResponseMeta';
    ...
    */
    ...
    public function setTotalItems($total_items)
    {
        ...
        if (($total_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_items when calling ClockifySettingsCollectionResponseMeta., must be bigger than or equal to 0.');
        }
    ...
    public function setItemsPerPage($items_per_page)
    {
        ...
        if (($items_per_page < 0)) {
            throw new \InvalidArgumentException('invalid value for $items_per_page when calling ClockifySettingsCollectionResponseMeta., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrentPage($current_page)
    {
        ...
        if (($current_page < 1)) {
            throw new \InvalidArgumentException('invalid value for $current_page when calling ClockifySettingsCollectionResponseMeta., must be bigger than or equal to 1.');
        }
