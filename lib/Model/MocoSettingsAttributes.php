...
/**
 * MocoSettingsAttributes Class Doc Comment
 *
 * @category Class
 * @description The MOCO Settings Attributes.
 * @package  Skriptfabrik\ApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MocoSettingsAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MocoSettingsAttributes';
    ...
    */
    ...
    public function setId($_id)
    {
        if (!is_null($_id) && (mb_strlen($_id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $_id when calling MocoSettingsAttributes., must be smaller than or equal to 26.');
        }
        if (!is_null($_id) && (mb_strlen($_id) < 26)) {
            throw new \InvalidArgumentException('invalid length for $_id when calling MocoSettingsAttributes., must be bigger than or equal to 26.');
        }
        if (!is_null($_id) && (!preg_match("/^[0-9A-HJ-KM-NP-TV-Z]{26}$/", $_id))) {
            throw new \InvalidArgumentException("invalid value for \$_id when calling MocoSettingsAttributes., must conform to the pattern /^[0-9A-HJ-KM-NP-TV-Z]{26}$/.");
        }
     ...
     * Sets host
     *
     * @param string $host MOCO API host
     *
     * @return self
     */
