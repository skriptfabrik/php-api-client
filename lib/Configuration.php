...
namespace Skriptfabrik\ApiClient;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://www.skriptfabrik.com';
    ...
    {
        $report  = 'PHP SDK (Skriptfabrik\ApiClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.1.2+e4727fd' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://www.skriptfabrik.com",
