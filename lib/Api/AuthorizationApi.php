...
class AuthorizationApi
{
     ...
     * @return \Skriptfabrik\ApiClient\Model\CreateAccessToken200Response|\Skriptfabrik\ApiClient\Model\CreateAccessToken400Response|\Skriptfabrik\ApiClient\Model\JSONAPIError
     */
     ...
     * @throws \Skriptfabrik\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Skriptfabrik\ApiClient\Model\CreateAccessToken200Response|\Skriptfabrik\ApiClient\Model\CreateAccessToken400Response|\Skriptfabrik\ApiClient\Model\JSONAPIError, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAccessTokenWithHttpInfo($create_access_token_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Skriptfabrik\ApiClient\Model\CreateAccessToken200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Skriptfabrik\ApiClient\Model\CreateAccessToken200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Skriptfabrik\ApiClient\Model\CreateAccessToken200Response', []),
                ...
                case 400:
                    if ('\Skriptfabrik\ApiClient\Model\CreateAccessToken400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Skriptfabrik\ApiClient\Model\CreateAccessToken400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Skriptfabrik\ApiClient\Model\CreateAccessToken400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Skriptfabrik\ApiClient\Model\CreateAccessToken200Response';
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Skriptfabrik\ApiClient\Model\CreateAccessToken200Response',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Skriptfabrik\ApiClient\Model\CreateAccessToken400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
