...
/**
     ...
     */
    public function createAccessToken($create_access_token_request = null, string $contentType = self::contentTypes['createAccessToken'][0])
    {
     ...
     */
    public function createAccessTokenWithHttpInfo($create_access_token_request = null, string $contentType = self::contentTypes['createAccessToken'][0])
    {
     ...
     */
    public function createAccessTokenAsync($create_access_token_request = null, string $contentType = self::contentTypes['createAccessToken'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAccessTokenAsyncWithHttpInfo($create_access_token_request = null, string $contentType = self::contentTypes['createAccessToken'][0])
    {
        $returnType = '\Skriptfabrik\ApiClient\Model\CreateAccessTokenResponse';
        $request = $this->createAccessTokenRequest($create_access_token_request, $contentType);
     ...
     */
    public function createAccessTokenRequest($create_access_token_request = null, string $contentType = self::contentTypes['createAccessToken'][0])
    {
