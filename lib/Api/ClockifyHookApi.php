...
class ClockifyHookApi
{
     ...
     */
    public function createClockifyHook($include = null, $clockify_hook_create_request = null)
    {
        list($response) = $this->createClockifyHookWithHttpInfo($include, $clockify_hook_create_request);
        return $response;
    }
     ...
     */
    public function createClockifyHookWithHttpInfo($include = null, $clockify_hook_create_request = null)
    {
        $request = $this->createClockifyHookRequest($include, $clockify_hook_create_request);
     ...
     */
    public function createClockifyHookAsync($include = null, $clockify_hook_create_request = null)
    {
        return $this->createClockifyHookAsyncWithHttpInfo($include, $clockify_hook_create_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createClockifyHookAsyncWithHttpInfo($include = null, $clockify_hook_create_request = null)
    {
        $returnType = '\Skriptfabrik\ApiClient\Model\ClockifyHookResponse';
        $request = $this->createClockifyHookRequest($include, $clockify_hook_create_request);
     ...
     */
    public function createClockifyHookRequest($include = null, $clockify_hook_create_request = null)
    {
        ...
        if (isset($clockify_hook_create_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($clockify_hook_create_request));
            } else {
     ...
     * @return \Skriptfabrik\ApiClient\Model\ClockifyHookResponse|\Skriptfabrik\ApiClient\Model\JsonApiError|\Skriptfabrik\ApiClient\Model\JsonApiError|\Skriptfabrik\ApiClient\Model\JsonApiError
     */
    public function getClockifyHook($clockify_hook_id, $include = null)
    {
        list($response) = $this->getClockifyHookWithHttpInfo($clockify_hook_id, $include);
        return $response;
    }
     ...
     * @return array of \Skriptfabrik\ApiClient\Model\ClockifyHookResponse|\Skriptfabrik\ApiClient\Model\JsonApiError|\Skriptfabrik\ApiClient\Model\JsonApiError|\Skriptfabrik\ApiClient\Model\JsonApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getClockifyHookWithHttpInfo($clockify_hook_id, $include = null)
    {
        $request = $this->getClockifyHookRequest($clockify_hook_id, $include);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClockifyHookAsync($clockify_hook_id, $include = null)
    {
        return $this->getClockifyHookAsyncWithHttpInfo($clockify_hook_id, $include)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClockifyHookAsyncWithHttpInfo($clockify_hook_id, $include = null)
    {
        $returnType = '\Skriptfabrik\ApiClient\Model\ClockifyHookResponse';
        $request = $this->getClockifyHookRequest($clockify_hook_id, $include);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getClockifyHookRequest($clockify_hook_id, $include = null)
    {
     ...
     * @return void
     */
    public function updateClockifyHook($clockify_hook_id, $clockify_hook_update_request = null)
    {
        $this->updateClockifyHookWithHttpInfo($clockify_hook_id, $clockify_hook_update_request);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateClockifyHookWithHttpInfo($clockify_hook_id, $clockify_hook_update_request = null)
    {
        $request = $this->updateClockifyHookRequest($clockify_hook_id, $clockify_hook_update_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateClockifyHookAsync($clockify_hook_id, $clockify_hook_update_request = null)
    {
        return $this->updateClockifyHookAsyncWithHttpInfo($clockify_hook_id, $clockify_hook_update_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateClockifyHookAsyncWithHttpInfo($clockify_hook_id, $clockify_hook_update_request = null)
    {
        $returnType = '';
        $request = $this->updateClockifyHookRequest($clockify_hook_id, $clockify_hook_update_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateClockifyHookRequest($clockify_hook_id, $clockify_hook_update_request = null)
    {
        ...
        if (isset($clockify_hook_update_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($clockify_hook_update_request));
            } else {
