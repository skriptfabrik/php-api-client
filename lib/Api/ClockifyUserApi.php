...
class ClockifyUserApi
{
     ...
     * @throws \Skriptfabrik\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Skriptfabrik\ApiClient\Model\GetClockifyUser204Response|\Skriptfabrik\ApiClient\Model\JSONAPIError|\Skriptfabrik\ApiClient\Model\JSONAPIError|\Skriptfabrik\ApiClient\Model\JSONAPIError
     */
     ...
     * @throws \Skriptfabrik\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Skriptfabrik\ApiClient\Model\GetClockifyUser204Response|\Skriptfabrik\ApiClient\Model\JSONAPIError|\Skriptfabrik\ApiClient\Model\JSONAPIError|\Skriptfabrik\ApiClient\Model\JSONAPIError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getClockifyUserWithHttpInfo($clockify_user_id, $included = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 204:
                    if ('\Skriptfabrik\ApiClient\Model\GetClockifyUser204Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Skriptfabrik\ApiClient\Model\GetClockifyUser204Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Skriptfabrik\ApiClient\Model\GetClockifyUser204Response', []),
            ...
            $returnType = '\Skriptfabrik\ApiClient\Model\GetClockifyUser204Response';
            ...
            switch ($e->getCode()) {
                ...
                case 204:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Skriptfabrik\ApiClient\Model\GetClockifyUser204Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Skriptfabrik\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Skriptfabrik\ApiClient\Model\GetClockifyUserCollection200Response|\Skriptfabrik\ApiClient\Model\JSONAPIError|\Skriptfabrik\ApiClient\Model\JSONAPIError
     */
     ...
     * @throws \Skriptfabrik\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Skriptfabrik\ApiClient\Model\GetClockifyUserCollection200Response|\Skriptfabrik\ApiClient\Model\JSONAPIError|\Skriptfabrik\ApiClient\Model\JSONAPIError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getClockifyUserCollectionWithHttpInfo($limit = 10, $page = 1, $included = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Skriptfabrik\ApiClient\Model\GetClockifyUserCollection200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Skriptfabrik\ApiClient\Model\GetClockifyUserCollection200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Skriptfabrik\ApiClient\Model\GetClockifyUserCollection200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Skriptfabrik\ApiClient\Model\GetClockifyUserCollection200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Skriptfabrik\ApiClient\Model\GetClockifyUserCollection200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $clockify_user_id clockify_user_id (required)
     * @param  \Skriptfabrik\ApiClient\Model\UpdateClockifyUserRequest $update_clockify_user_request Update Clockify User Request (optional)
     *
     * @throws \Skriptfabrik\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateClockifyUser($clockify_user_id, $update_clockify_user_request = null)
    {
        $this->updateClockifyUserWithHttpInfo($clockify_user_id, $update_clockify_user_request);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateClockifyUserWithHttpInfo($clockify_user_id, $update_clockify_user_request = null)
    {
        $request = $this->updateClockifyUserRequest($clockify_user_id, $update_clockify_user_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateClockifyUserAsync($clockify_user_id, $update_clockify_user_request = null)
    {
        return $this->updateClockifyUserAsyncWithHttpInfo($clockify_user_id, $update_clockify_user_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateClockifyUserAsyncWithHttpInfo($clockify_user_id, $update_clockify_user_request = null)
    {
        $returnType = '';
        $request = $this->updateClockifyUserRequest($clockify_user_id, $update_clockify_user_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateClockifyUserRequest($clockify_user_id, $update_clockify_user_request = null)
    {
        ...
        // for model (json/xml)
        if (isset($update_clockify_user_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($update_clockify_user_request));
            } else {
                $httpBody = $update_clockify_user_request;
            }
